        ...
        {data &&
            <section className="w-[100%] text-lg mb-[2rem] px-[1.5rem] py-[2rem] bg-white drop-shadow-xl">
                <p className='text-xl my-4 text-center'>
                    The voucher is available. It has 
                    <span className="text-green-600 font-semibold mx-1">{data?.points} points.</span> 
                    Click the button below to redeem them.
                </p>
                ...
                <div className='flex items-start justify-start gap-4 mb-2'>
                    ...
                    <div className='w-[80%] font-semibold'>{data?.points}</div>      
                </div>
